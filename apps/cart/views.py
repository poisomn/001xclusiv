...
def _serialize_cart(cart):
    ...
    return {
        ...
        "net_amount": float(cart.get_net_amount()),
        "net_amount_formatted": _format_clp(cart.get_net_amount()),
        "tax_amount": float(cart.get_tax_amount()),
        "tax_amount_formatted": _format_clp(cart.get_tax_amount()),
