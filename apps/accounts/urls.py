...
from .forms import GmailPasswordResetForm
from . import views
...
urlpatterns = [
    ...
    path('backoffice/promotions/', views.BackofficePromotionListView.as_view(), name='backoffice_promotions'),
    path('backoffice/promotions/new/', views.BackofficePromotionFormView.as_view(), name='backoffice_promotion_create'),
    path('backoffice/promotions/<int:promotion_id>/edit/', views.BackofficePromotionFormView.as_view(), name='backoffice_promotion_edit'),
    path('backoffice/promotions/<int:promotion_id>/action/', views.BackofficePromotionActionView.as_view(), name='backoffice_promotion_action'),
